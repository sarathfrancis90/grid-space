...
interface UIState {
  ...
  isTableManagerOpen: boolean;
  isConvertToTableOpen: boolean;
  ...
  setTableManagerOpen: (open: boolean) => void;
  setConvertToTableOpen: (open: boolean) => void;
...
export const useUIStore = create<UIState>()(
  immer((set) => ({
    ...
    isTableManagerOpen: false,
    isConvertToTableOpen: false,
    isFormulaMode: false,
    formulaReferences: [],
    ...
    setTableManagerOpen: (open: boolean) => {
      set((state) => {
        state.isTableManagerOpen = open;
      });
    },

    setConvertToTableOpen: (open: boolean) => {
      set((state) => {
        state.isConvertToTableOpen = open;
      });
    },
