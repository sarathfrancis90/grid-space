    ...
    <div
      className={
        inline
          ...
          : "w-[400px] rounded-lg bg-white shadow-xl"
      }
      onClick={(e) => e.stopPropagation()}
      data-testid="view-setup-dialog"
    >
      <div
        className={inline ? "px-5 py-2" : "border-b border-gray-200 px-5 py-4"}
      >
        <h3
          className={
            inline
      ...
      <div
        className={
          inline
            ? "flex flex-wrap items-end gap-3 px-5 py-2"
            : "space-y-3 px-5 py-4"
        }
      >
        {fields.map((field) => (
          <div key={field.key} className={inline ? "min-w-[160px]" : ""}>
