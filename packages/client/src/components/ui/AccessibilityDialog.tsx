/**
 * AccessibilityDialog — stub accessibility checker/settings dialog.
 */
import { useUIStore } from "../../stores/uiStore";

export function AccessibilityDialog() {
  const isOpen = useUIStore((s) => s.isAccessibilityDialogOpen);
  ...
  return (
    <div
      ...
      onClick={handleClose}
      data-testid="accessibility-dialog-backdrop"
    >
      <div
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-gray-200 px-6 py-4">
          ...
          <button
            ...
            data-testid="accessibility-dialog-close"
            type="button"
          >
            <svg
              width="20"
        ...
        <div className="px-6 py-5">
          <p
            ...
            data-testid="accessibility-dialog-message"
          >
            No accessibility issues found. Your spreadsheet meets basic
        ...
        <div className="flex justify-end border-t border-gray-200 px-6 py-3">
          <button
            ...
            data-testid="accessibility-dialog-ok"
            type="button"
          >
            OK
          </button>
