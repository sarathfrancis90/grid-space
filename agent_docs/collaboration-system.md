...
```typescript
const COLORS = ['#4285F4','#EA4335','#FBBC04','#34A853','#FF6D01',
                '#46BDC6','#7B1FA2','#C2185B','#00897B','#6D4C41',
                '#1565C0','#2E7D32','#E65100','#4527A0','#AD1457',
                '#00838F','#558B2F','#BF360C','#283593','#1B5E20'];
...
socket.on('cell-edit-start', (data) => {
  ...
  socket.to(`spreadsheet:${data.spreadsheetId}`).emit('cell-locked', {
    cell: data.cell, sheetId: data.sheetId, userId: socket.data.user.id,
  });
});
